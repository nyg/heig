 ...
 */
  ...
  def getClosestWordInDictionary(misspelledWord: String): String = {
    ...
    if (misspelledWord.forall(Character.isDigit) || misspelledWord.startsWith("_")) {
      ...
      // Build a list of tuples that contains the Levenshtein score for each of the dictionary's keys, according to the given misspelled word,
      // e.g. (("bonjour", 4), ("hello", 1), (...))
